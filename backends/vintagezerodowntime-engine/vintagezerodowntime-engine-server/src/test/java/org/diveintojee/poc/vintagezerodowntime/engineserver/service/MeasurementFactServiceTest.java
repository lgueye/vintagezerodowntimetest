...
public class MeasurementFactServiceTest {
    ...
    public void createShouldSucceed() throws Exception {
        ...
        final String businessId = String.format(MeasurementFactService.BUSINESSID_TEMPLATE, deviceBusinessId, timestamp);
        final String destination = String.format(MeasurementFactService.DESTINATION_TEMPLATE, deviceBusinessId);
    ...
    public void findByCriteriaShouldSucceed() throws Exception {
        ...
        String provider = "any-provider";
        MeasurementFactDTO criteria = MeasurementFactDTO.of(deviceBusinessId, provider);
        MeasurementFact probe = MeasurementFact.of(deviceBusinessId, provider, null, null, null, null);
        ...
        final String b0 = String.format(MeasurementFactService.BUSINESSID_TEMPLATE, deviceBusinessId, t0);
        final int v0 = 97;
        MeasurementFact h0 = MeasurementFact.of(deviceBusinessId, provider, v0, t0, b0, i0);
        final long t1 = now.minusMillis(7).toEpochMilli();
        final long i1 = now.plusMillis(3).toEpochMilli();
        final String b1 = String.format(MeasurementFactService.BUSINESSID_TEMPLATE, deviceBusinessId, t1);
        final int v1 = 121;
        MeasurementFact h1 = MeasurementFact.of(deviceBusinessId, provider, v1, t1, b1, i1);
